...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-2 content3 contentTitle">
				<a> Logged as <%= request.getParameter("email") %> </a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-5 contentLogin content">
				<form action="/m8_servlets/Login/login.jsp">
					<input type="submit" value="Log in"/>
				</form>
			</div>
			<div class="col-5 contentRegister content">
				<form action="/m8_servlets/Register/register.jsp">
	...
	<div class="container">
		<div class="row">
			<div class="col-11 contentNews content">
				<a>News</a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-11 contentShop content">
				<form action="/m8_servlets/Cursos/ofertaCursos.jsp">
					<input type="hidden" id="email" name="email" value="<%= request.getParameter("email") %>"/>
					<input type="submit" value="Oferta Cursos"/>
				</form>
			</div>
		</div>
	</div>
